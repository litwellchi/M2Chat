...
# CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -u -m torch.distributed.launch --master_port=11313 --nproc_per_node=4 --use_env \
# CUDA_VISIBLE_DEVICES=0 python3 -u -m torch.distributed.launch --master_port=11345 --nproc_per_node=1 --use_env \
