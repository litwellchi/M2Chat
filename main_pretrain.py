...
def main(args):
    ...
    # llama_ckpt_dir = args.llama_path
    ...
    dataset_train = ccxm_Dataset(args.data_config, transform=transform_train,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and (epoch % 1 == 0 or epoch + 1 == args.epochs):
            ...
            with torch.cuda.amp.autocast():
                img = model_without_ddp.t2i_generate(prompts=["A door with a sticker of a cat door on it"])
                sdxl_img = model_without_ddp.t2i_generate(prompts=["A door with a sticker of a cat door on it"], use_origin=True, seed=epoch)
            ...
            if misc.is_main_process():
                ...
                to_save = {     #'sd_query', 'sd_query_block', 'text_unpooled_proj', 'text_pooled_proj'
